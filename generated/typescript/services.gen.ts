...
export class Permissions {
     ...
     *
     */
    public static getMyPermissions<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
